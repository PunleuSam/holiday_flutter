...
import 'package:holiday_flutter/screens/comments_screen.dart';
...
import 'package:holiday_flutter/widgets/like_animation.dart';
          ...
          Row(
            children: <Widget>[
              ...
              Expanded(
                ...
                child: IconButton(
                    icon: const Icon(Icons.send_rounded), onPressed: () {}),
              ))
            ],
          ),
